...
const createBooks = async (req, res) => {
    ...
    //********************************************************************************************************************************************** */
         ...
         return res.status(400).send({status:false, msg: "User Id doesn't present in our Database"})

         if(await bookmodel.exists(data))
         return res.status(400).send({status:false, msg:"Book already present"})
